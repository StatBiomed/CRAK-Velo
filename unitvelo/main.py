...
def run_model(config):
    ...
    #df_rg_intersection.to_csv('/data/nelkazwi/RNA_velo/Unitvelo_atac/df_regions_genes/10X_mouse_brain_10000_mv_cells_800_regions.csv',sep='\t')
    B, adata_atac = gene_regions_binary_matrix(config, adata, adata_atac, df_rg_intersection, logger)
    np.savetxt('/data/nelkazwi/RNA_velo/Unitvelo_atac/HSPC/B_mouse_brain.txt', B, delimiter=',')
